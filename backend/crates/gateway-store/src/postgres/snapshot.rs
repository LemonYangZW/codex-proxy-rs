...
impl SnapshotStorePort for PgRuntimeSnapshotRepository {
    fn load_snapshot_facts(
        ...
        Box::pin(async move {
            ...
            .with_passive_state_capture_enabled(data.settings.passive_state_capture_enabled)
